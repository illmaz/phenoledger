...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'breeding-records', label: 'Breeding Records', Icon: GitMerge,  phase: 'p2' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'dus-tests',         label: 'DUS Testing',       Icon: FlaskConical, phase: 'p4' },
      { id: 'tissue-culture',    label: 'Tissue Culture',    Icon: Microscope,   phase: 'p4' },
